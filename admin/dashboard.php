...
<head>
    ...
    <style>
        body {
            font-family: 'shabnam-400' !important;
        }
    </style>
    <![endif]-->
</head>
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" style="font-family: 'shabnam-400', sans-serif">
                        <li><a class="" href="dashboard.php?m=menu&p=list"><i class="icon-list"></i>لیست منو ها</a></li>
                        <li><a class="" href="dashboard.php?m=menu&p=add"><i class="icon-plus"></i>افزودن منو جدید</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="#" class="">
                    ...
                    <ul class="sub" style="font-family: 'shabnam-400', sans-serif">
                        <li><a class="" href="#"><i class="icon-plus"></i>افزودن کاربر</a></li>
                        <li><a class="" href="#"><i class="icon-list"></i>لیست کاربران</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="#" class="">
                    ...
                    <ul class="sub" style="font-family: 'shabnam-400', sans-serif">
                        <li><a class="" href="#"><i class="icon-plus"></i>افزودن پست</a></li>
                        <li><a class="" href="#"><i class="icon-list"></i>لیست پست ها</a></li>
                    </ul>
                </li>
            </ul>
            <!-- sidebar menu end-->
